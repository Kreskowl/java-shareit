...
public class ItemRequestControllerTest {
    ...
    void shouldCreateRequest() throws Exception {
        when(client.createItemRequest(any(), eq(USER_ID)))
    ...
    void shouldGetAllUserRequests() throws Exception {
        when(client.findAllUserRequests(USER_ID))
    ...
    void shouldGetAllOtherUsersRequests() throws Exception {
        when(client.findAllOtherRequests(USER_ID))
                .thenReturn(ResponseEntity.ok(List.of(responseDto)));
    ...
    void shouldFindRequestById() throws Exception {
        when(client.findById(REQUEST_ID))
                .thenReturn(ResponseEntity.ok(responseDto));
