...
public class ItemControllerTest {
    ...
    void shouldCreateItem() throws Exception {
        ...
        when(client.createItem(eq(1L), any())).thenReturn(ResponseEntity.ok(responseDto));
    ...
    void shouldGetItemById() throws Exception {
        when(client.findItemById(eq(USER_ID), eq(ITEM_ID))).thenReturn(ResponseEntity.ok(responseDto));
    ...
    void shouldUpdateItemById() throws Exception {
        ...
        when(client.update(eq(USER_ID), eq(ITEM_ID), any())).thenReturn(ResponseEntity.ok(updatedResponse));
    ...
    void shouldGetAllUserItems() throws Exception {
        when(client.findAllByOwnerId(1L)).thenReturn(ResponseEntity.ok(List.of()));
    ...
    void shouldSearchItems() throws Exception {
        when(client.search("hammer")).thenReturn(ResponseEntity.ok(List.of()));
    ...
    void shouldReturnNotFoundIfItemDoesNotExist() throws Exception {
        ...
        when(client.findItemById(itemId, USER_ID))
